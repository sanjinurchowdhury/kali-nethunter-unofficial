...
function check_kex() {
    if [ "$wimg" = "nano" ] || [ "$wimg" = "minimal" ]; then
        nh sudo apt update && nh sudo apt install -y tightvncserver kali-desktop-gnome
    fi
}
...
printf "${green}[#]This is an unofficial version of NetHunter for Termux${reset}\n"
...
printf "${green}[+] nethunter kex &       # To start NetHunter Kex${reset}\n"
printf "${green}[+] nethunter kex stop    # To stop NetHunter Kex${reset}\n"
printf "${green}[+] nethunter kex <command> # Run command in NetHunter env${reset}\n"
printf "${green}[+] nethunter -r          # To start NetHunter CLI as root${reset}\n"
printf "${green}[+] nethunter -r kex passwd  # To set the KeX password for root${reset}\n"
printf "${green}[+] nethunter -r kex &       # To start NetHunter Kex as root${reset}\n"
printf "${green}[+] nethunter kex -r stop    # To stop NetHunter KeX root session${reset}\n"
printf "${green}[+] nethunter -r kex kill # To stop all NetHunter KeX sessions${reset}\n"
printf "${green}[+] nethunter -r <command> # Run command in NetHunter env as root${reset}\n"
printf "${green}[+] nh                    # Replacement for nethunter${reset}\n\n"
